...
url = paste0(
  "https://www.ncei.noaa.gov/access/services/data/v1?dataset=daily-summaries&dataTypes=PRCP,TMAX,TMIN&stations=USC00118740&startDate=",
  earliest,
  "&endDate=",
  latest,
  "&units=standard"
...
if (empty_check == FALSE) {
  write_csv(ncei, file = "data/ncei.csv")
}
