...
[Community levels](https://www.cdc.gov/coronavirus/2019-ncov/science/community-levels.html) are calculated by the CDC based on case and hospital data. [Community transmission levels](https://covid.cdc.gov/covid-data-tracker/#county-view) are calculated by the CDC based on new cases per capita in the past week and test positivity.
